...
def run_PTI(name,run_name='',use_wandb=False, use_multi_id_training=False):
    ...
    dataset = ImagesDataset(paths_config.input_data_path, name, transforms.Compose([
        transforms.ToTensor(),
...
if __name__ == '__main__':
    import sys
    name = sys.argv[1]
    run_PTI(name,run_name='', use_wandb=False, use_multi_id_training=False)
